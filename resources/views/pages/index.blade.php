    ...
    <div class="aa-slider-area">
      <div id="sequence" class="seq">
         <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="{{asset('public/frontend/img/slider/1.jpg')}}" alt="Men slide img" />
              </div>
              <div class="seq-title">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{asset('public/frontend/img/man/polo-shirt-2.png')}}" alt="polo shirt img"></a>
